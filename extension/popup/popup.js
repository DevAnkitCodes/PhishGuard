document.addEventListener('DOMContentLoaded', function() {
    console.log("PhishGuard Popup Initialized");

    // [RENDER UPDATE] Replace this with your actual Render URL
    ...
    fetch(`${BASE_URL}/`)
        ...
        .catch(error => {
            ...
            console.log("Backend not reachable. Ensure Render service is active!");
        });
